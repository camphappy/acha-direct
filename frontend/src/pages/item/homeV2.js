...
const Home = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const checkResponse = await fetch(`/acha-kvell/upload/check-file?filename=${fileSelected.name}`);
            ...
            if (!response.ok) {
                throw new Error('File upload frontend failed');
            }
            ...
            window.alert('File upload frontend catch failed');
        }
    };
