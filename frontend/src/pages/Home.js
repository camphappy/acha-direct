...
const Home = () => {
    ...
    //Images must always be under MernStart/backend/public/
                        ...
                        {imageExists ? (
                            <div
                                ...
                                <img
                                        ...
                                        onError={(e) => {
                                            console.error(`Failed to load image at ${currentFileLocation}`);
                                            //e.target.onerror = null; // Prevents infinite loop if error image fails
                                            //e.target.src = 'https://www.achadirect.com/static/version1716261394/frontend/store/acha/en_US/images/logo.webp'; // Path to a fallback image
                                        }}
                                />
